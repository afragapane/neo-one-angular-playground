...
export class Token extends SmartContract {
  ...
  public approveReceiveTransfer(from: Address, amount: Fixed<8>, asset: Address): boolean {
    return false;
  }
  ...
  public onRevokeSendTransfer(from: Address, amount: Fixed<8>, asset: Address): void {
    // do nothing
  }
